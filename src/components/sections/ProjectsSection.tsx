...
const CARD_BASE =
  "flex h-full flex-col rounded-2xl border border-border bg-surface-elevated/50 p-6 shadow-sm md:p-8";
            ...
            >
              {hasLink ? (
                <a
                  ...
                  className={cn(
                    CARD_BASE,
                    "transition-all duration-300 hover:border-brand/35 hover:shadow-md",
                  )}
                >
                  {body}
                </a>
